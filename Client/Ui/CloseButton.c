...
static void message_button_on_render(struct rr_ui_element *this,
                                     struct rr_game *game)
{
    struct rr_renderer *renderer = game->renderer;
    rr_renderer_scale(renderer, renderer->scale);
    ...
    rr_renderer_line_to(renderer, this->abs_width * 0.25,
                        this->abs_height * 0.1);
    rr_renderer_line_to(renderer, this->abs_width * 0.15,
                        this->abs_height * 0.1);
    rr_renderer_line_to(renderer, this->abs_width * 0.15,
                        this->abs_height * 0.25);
...
struct rr_ui_element *rr_ui_message_button_init(
    float w, void (*on_event)(struct rr_ui_element *, struct rr_game *))
{
    struct rr_ui_element *this = rr_ui_element_init();
    this->abs_width = this->abs_height = w;
