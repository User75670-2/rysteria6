        ...
        rr_ui_set_background(
            rr_ui_v_container_init(
                ...
                rr_ui_h_container_init(
                    ...
                    squad_loadout_button_init(&member->loadout[10], 1),
                    squad_loadout_button_init(&member->loadout[11], 1), NULL),
                rr_ui_h_container_init(
                    rr_ui_container_init(), 0, 5,
                    ...
                    squad_loadout_button_init(&member->loadout[20], 0),
                    squad_loadout_button_init(&member->loadout[21], 0),
                    squad_loadout_button_init(&member->loadout[22], 0),
                    squad_loadout_button_init(&member->loadout[23], 0), NULL),
                NULL),
            0x80000000),
        -1, -1);
