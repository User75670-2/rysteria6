                            ...
                            uint8_t flags)
{
    ...
    else
    {
        ...
        case rr_petal_id_leaf:
            ...
            rr_renderer_scale(renderer, 1 / 0.2);
            break;
        case rr_petal_id_gleaf:
            rr_renderer_scale(renderer, 0.2);
            rr_renderer_rotate(renderer, M_PI * 3 / 4);
            rr_renderer_set_fill(renderer, 0xfffef513);
            rr_renderer_begin_path(renderer);
            rr_renderer_move_to(renderer, -42.50, 42.73);
            rr_renderer_bezier_curve_to(renderer, -66.06, 19.17, -66.06, -19.02,
                                        -42.50, -42.58);
            ...
            rr_renderer_line_to(renderer, -29.53, -48.03);
            rr_renderer_fill(renderer);
            rr_renderer_set_fill(renderer, 0xfffdf11c);
            rr_renderer_begin_path(renderer);
            rr_renderer_move_to(renderer, 0.06, 42.80);
            rr_renderer_bezier_curve_to(renderer, -23.49, 42.80, -42.58, 23.71,
                                        -42.58, 0.16);
        ...
        case rr_petal_id_orni_egg:
            ...
            rr_renderer_stroke(renderer);
            break;
        case rr_petal_id_ant_egg:
            rr_renderer_set_stroke(renderer, 0xff0e040a);
        ...
        case rr_petal_id_hornet_egg:
            rr_renderer_set_stroke(renderer, 0xff4c3c0d);
            ...
            rr_renderer_stroke(renderer);
            break;
        case rr_petal_id_dragonfly_egg:
            rr_renderer_set_stroke(renderer, 0xff0c1d32);
        ...
        case rr_petal_id_honeybee_egg:
            rr_renderer_set_stroke(renderer, 0xff130a00);
            ...
            rr_renderer_stroke(renderer);
            break;
        case rr_petal_id_beehive_egg:
            rr_renderer_set_stroke(renderer, 0xff715309);
        ...
        case rr_petal_id_house_centipede_egg:
            ...
            rr_renderer_stroke(renderer);
            break;
        case rr_petal_id_lanternfly_egg:
            rr_renderer_set_stroke(renderer, 0xff6d5948);
