                                    ...
                                    uint8_t rarity, EntityIdx owner)
{
    ...
    if (id == rr_petal_id_superfling)
    {
        rr_component_physical_set_radius(physical, 15);
        physical->mass = 25 * powf(1.8, rarity);
        physical->knockback_scale = 100000000000000.0f;
    }
    ...
    switch (rarity) {
        ...
        case 8:  burn_damage = 68040.0 / 75; break;
        case 9:  burn_damage = 238140.0 / 75;break;
        case 10: burn_damage = 833490.0 / 75;break;
